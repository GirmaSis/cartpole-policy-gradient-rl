...
class Policy(nn.Module):
    """
    Implements both actor and critic in a single network
    """
    def __init__(self):
...
def modify_pole_color(frame):
    ...
    frame[mask > 0] = [255, 0, 0]  # Change black pole to red
    return frame
...
def main():
    ...
    plt.xlabel('Episode')
    plt.ylabel('Reward')
    plt.title('Training Performance: Optimized Actor-Critic')
    plt.legend()
    plt.show()
